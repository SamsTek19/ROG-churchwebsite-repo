...
const events = [
  {
    ...
    time: '9am to 12pm',
    location: 'Kotwi Presby Auditorium',
    description: 'A time where ladies meet to intercede and grow in Christ.',
    image: 'https://res.cloudinary.com/dzydzt8x8/image/upload/v1759843428/WhatsApp_Image_2025-10-07_at_13.09.52_60f54cef_htemsz.jpg'
  },
  {
    id: 1,
