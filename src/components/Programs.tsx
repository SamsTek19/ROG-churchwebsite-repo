...
const programs = [
  {
    ...
    description: "Our intercessory prayer ministry provides a fun, safe environment where kids can learn about God's love through age-appropriate activities, Bible stories, and worship.",
  ...
  },
  {
    id: 2,
    title: "Youth Group",
    description: "Our vibrant youth ministry helps teens grow in their faith through weekly gatherings, small groups, service projects, and fun activities.",
  ...
  },
  {
    ...
    description: "Our worship team leads the congregation in meaningful praise and worship through music, creating an atmosphere where people can encounter God's presence.",
  ...
  },
  {
    ...
    description: "We're committed to sharing God's love both locally and globally through various outreach initiatives, community service, and mission trips.",
