    ...
    <section id="contact" className="py-16 md:py-24 bg-orange-50">
      <div className="container mx-auto px-4">
            ...
            <div className="space-y-6">
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-gray-700">radianceofgloryembassy@gmail.com</p>
                </div>
              </div>
        ...
        <div className="mt-12 bg-white rounded-lg overflow-hidden shadow-lg h-96">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3969.9200000000005!2d-1.5770308!3d6.6770453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdb946c039d9ff5%3A0x514542f6f0ca35fb!2sQueens%20Hall!5e0!3m2!1sen!2sgh!4v1716451515102!5m2!1sen!2sgh" width="600" height="450" style={{border:0}} allowFullScreen title="Google Maps" className="w-full h-full"></iframe>
